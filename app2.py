...
#!pip install flask-apispec   ---提供一個簡易型Web框架給restful API,將其部屬到前端(Swagger網頁)
#!pip install flask-jwt-extended   ---用來處理授權(TOKEN)

import flask
from flask_restful import Api
from resource.item import Items, Item, Login  # 引用item.py的class物件
...
app.config.update({    
   'APISPEC_SPEC': APISpec(
       title='LiLiLaLa Shopping Mall',   # 網頁標題名稱
       version='v1',
